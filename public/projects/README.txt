...
- Painel de administração protegido por senha para gerenciar projetos,
  certificados e mensagens de contato sem tocar em código
...
| Dados | mockapi.io (projetos, certificados, mensagens), com fallback local |
| E-mail | Resend |
...
partir do navegador; já as mensagens de contato passam por uma rota de
API própria, que nunca expõe credenciais ou URLs internas ao cliente.
...
contra bots, e envio via Resend com um backup opcional no mockapi para
consulta posterior no painel.
